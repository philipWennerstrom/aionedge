...
public class AddTitle extends AdminCommand {
	...
	public void execute(Player player, String... params) {
		...
		if ((titleId > 234) || (titleId < 1)) {
			PacketSendUtility.sendMessage(player, "title id " + titleId + " is invalid (must be between 1 and 234)");
			return;
		}
		...
		if (titleId < 235)
			titleId = target.getRace().getRaceId() * 234 + titleId;
