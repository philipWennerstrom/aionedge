...
public class _28620KaligasCollection extends QuestHandler {
	...
	public void register() {
		qe.registerQuestNpc(730328).addOnQuestStart(questId);
		qe.registerQuestNpc(730328).addOnTalkEvent(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 730328) {
			...
			if ((playerClass == PlayerClass.RANGER || playerClass == PlayerClass.ASSASSIN || playerClass == PlayerClass.MAGE
				...
				|| playerClass == PlayerClass.WARRIOR || playerClass == PlayerClass.SCOUT) && player.getRace() == Race.ASMODIANS) {
				if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
