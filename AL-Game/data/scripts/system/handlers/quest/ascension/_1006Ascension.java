							...
							if (qs.getQuestVars().getQuestVars() == 99) {
								...
								ThreadPoolManager.getInstance().schedule(new Runnable() {
									...
									public void run() {
										...
										mobs.add((Npc) QuestService.spawnQuestNpc(310010000, instanceId, 211042, (float) 224.073,
											(float) 239.1, (float) 206.7, (byte) 0));
										mobs.add((Npc) QuestService.spawnQuestNpc(310010000, instanceId, 211042, (float) 233.5,
											(float) 241.04, (float) 206.365, (byte) 0));
										mobs.add((Npc) QuestService.spawnQuestNpc(310010000, instanceId, 211042, (float) 229.6,
											(float) 265.7, (float) 205.7, (byte) 0));
										mobs.add((Npc) QuestService.spawnQuestNpc(310010000, instanceId, 211042, (float) 222.8,
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (targetId == 211042) {
				...
				if (var >= 51 && var < 54) {
					...
					qs.setQuestVar(4); // 4
					updateQuestStatus(env);
					Npc mob = (Npc) QuestService.spawnQuestNpc(310010000, player.getInstanceId(), 211043, (float) 226.7,
