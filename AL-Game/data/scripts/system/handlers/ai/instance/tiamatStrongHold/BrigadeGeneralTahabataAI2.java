...
public class BrigadeGeneralTahabataAI2 extends AggressiveNpcAI2 {
			...
			if (hpPercentage <= percent) {
				switch (percent) {
					...
					case 7:
						...
						spawn(283237, 679.88f, 1068.88f, 497.88f, (byte) 0);
						break;
				}
	...
	private void deleteAdds() {
		...
		deleteNpcs(instance.getNpcs(283252));
		deleteNpcs(instance.getNpcs(283253));
		deleteNpcs(instance.getNpcs(283254));
		deleteNpcs(instance.getNpcs(283255));
		deleteNpcs(instance.getNpcs(283256));
