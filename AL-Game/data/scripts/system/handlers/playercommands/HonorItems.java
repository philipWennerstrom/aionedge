...
public class HonorItems extends PlayerCommand {
	...
	public void execute(Player player, String... params) {
	    if (params.length < 1) {
			PacketSendUtility.sendMessage(player, "Syntax: .items <plate | leather | cloth | chain | weapons>");
			PacketSendUtility.sendMessage(player, "Syntax: .items <pprices | lprices | cprices | ccprices | wprices>");
			return;
		}
	...
	private void plateInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Platten Ruestungs Preise");
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendMessage(player, "[item: 110601342] AP: 4329504 Meds: 105");//Plate Breast
		PacketSendUtility.sendMessage(player, "[item: 111601305] AP: 2164752 Meds: 52");//Plate Hands
		PacketSendUtility.sendMessage(player, "[item: 114601291] AP: 2164752 Meds: 52");//Plate Shoes
		PacketSendUtility.sendMessage(player, "[item: 113601294] AP: 3247344 Meds: 78");//Plate Pants
		PacketSendUtility.sendMessage(player, "[item: 112601285] AP: 2164752 Meds: 52");//Plate Shoulders
		PacketSendUtility.sendMessage(player, "----------------");
	}
	
	private void leatherInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Leder Ruestungs Preise");
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendMessage(player, "[item: 110301393] AP: 4329504 Meds: 105");//Leather Breast
		PacketSendUtility.sendMessage(player, "[item: 111301334] AP: 2164752 Meds: 52");//Leather Hands
		PacketSendUtility.sendMessage(player, "[item: 114301393] AP: 2164752 Meds: 52");//Leather Shoes
		PacketSendUtility.sendMessage(player, "[item: 113301358] AP: 3247344 Meds: 78");//Leather Pants
		PacketSendUtility.sendMessage(player, "[item: 112301277] AP: 2164752 Meds: 52");//Leather Shoulders
		PacketSendUtility.sendMessage(player, "----------------");
	}
	
	private void clothInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Stoff Ruestungs Preise");
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendMessage(player, "[item: 110101485] AP: 4329504 Meds: 105");//Cloth Breast
		PacketSendUtility.sendMessage(player, "[item: 111101339] AP: 2164752 Meds: 52");//Cloth Hands
		PacketSendUtility.sendMessage(player, "[item: 114101387] AP: 2164752 Meds: 52");//Cloth Shoes
		PacketSendUtility.sendMessage(player, "[item: 113101356] AP: 3247344 Meds: 78");//Cloth Pants
		PacketSendUtility.sendMessage(player, "[item: 112101296] AP: 2164752 Meds: 52");//Cloth Shoulders
		PacketSendUtility.sendMessage(player, "----------------");
	}
	
	private void chainInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Ketten Ruestungs Preise");
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendMessage(player, "[item: 110501368] AP: 4329504 Meds: 105");//Chain Breast
		PacketSendUtility.sendMessage(player, "[item: 111501326] AP: 2164752 Meds: 52");//Chain Hands
		PacketSendUtility.sendMessage(player, "[item: 114501349] AP: 2164752 Meds: 52");//Chain Shoes
		PacketSendUtility.sendMessage(player, "[item: 113501341] AP: 3247344 Meds: 78");//Chain Pants
		PacketSendUtility.sendMessage(player, "[item: 112501266] AP: 2164752 Meds: 52");//Chain Shoulders
		PacketSendUtility.sendMessage(player, "----------------");
	}
	
	private void weaponsInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Waffen Preise");
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendMessage(player, "[item: 100001412] AP: 6494256 Meds: 156");//Weapon Sword
		PacketSendUtility.sendMessage(player, "[item: 100901105] AP: 6494256 Meds: 156");//Weapon Greatsword
		PacketSendUtility.sendMessage(player, "[item: 101701134] AP: 6494256 Meds: 156");//Weapon Longbow
		PacketSendUtility.sendMessage(player, "[item: 100201251] AP: 6494256 Meds: 156");//Weapon Dagger
		PacketSendUtility.sendMessage(player, "[item: 100501097] AP: 6494256 Meds: 156");//Weapon Orb
		PacketSendUtility.sendMessage(player, "[item: 100601153] AP: 6494256 Meds: 156");//Weapon Tome
		PacketSendUtility.sendMessage(player, "[item: 101501123] AP: 6494256 Meds: 156");//Weapon Staff
		PacketSendUtility.sendMessage(player, "[item: 100101089] AP: 6494256 Meds: 156");//Weapon Mace
		PacketSendUtility.sendMessage(player, "[item: 115001462] AP: 4329504 Meds: 105");//Weapon Shield
		PacketSendUtility.sendMessage(player, "[item: 101301042] AP: 6494256 Meds: 156");//Weapon Spear
		PacketSendUtility.sendMessage(player, "----------------");
	}
	
	private void plate(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Platten Ruestung");
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, "Gebe nun .items und die entsprechende ID ein (Als Beispiel: .items 1");
	}
	
	private void leather(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Leder Ruestung");
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, "Gebe nun .items und die entsprechende ID ein (Als Beispiel: .items 6");
	}
	
	private void cloth(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Stoff Ruestung");
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, "Gebe nun .items und die entsprechende ID ein (Als Beispiel: .items 11");
	}
	
	private void chain(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, "Ketten Ruestung");
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, "Gebe nun .items und die entsprechende ID ein (Als Beispiel: .items 16");
	}
	...
	private void weapons(Player player) {
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, "Gebe nun .items und die entsprechende ID ein (Als Beispiel: .items 21");
	}
	...
	private void case1(Player player) {//Plate Breast
		...
		if (player.getAbyssRank().getAp() < ap) {
            PacketSendUtility.sendYellowMessageOnCenter(player, "Du hast nicht genug AP, du hast nur: " + ap);
            return;
        }
		if (itemsInBag < count) {
			PacketSendUtility.sendYellowMessageOnCenter(player, "Du hast nicht genug Medaillen, du hast nur: " + count);
			return;
		}
		...
		PacketSendUtility.sendMessage(player, "Du hast erfolgreich dein Item erhalten!");
	}
