...
JAVA %JAVA_OPTS% -Xbootclasspath/p:libs/jsr166-1.0.0.jar -ea -javaagent:./libs/Users\wennerstrom\.m2\repository\org\aionlightning\al-commons\1.3\al-commons-1.3.jar -cp ./libs/*;AL-Game.jar com.aionemu.gameserver.GameServer
